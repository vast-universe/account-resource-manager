...
def normalize_proxy_url(proxy_url: Optional[str]) -> Optional[str]:
    """Normalize proxy URL for worker clients.

    Bare host/user proxy strings are treated as HTTP proxies. socks5:// is
    normalized to socks5h:// to avoid local DNS leaks.
    """
